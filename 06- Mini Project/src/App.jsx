...
function App() {
  ...
  const jobOpenings = [
    ...
    {
      brandLogo: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRFe0bGjNOIa3S2yZgT3VOsYjFezjp7yXfFlCRLgwwKMf8Mw0yoZcxmAzg&s",
      companyName: "Netflix",
  ...
  return (
    ...
    <div className="card-container">
      {jobOpenings.map(function(elem){
        ...
        return <Card brandLogo={elem.brandLogo} company={elem.companyName} post={elem.post} datePosted={elem.datePosted} tag1={elem.tag1} tag2={elem.tag2} pay={elem.pay} location={elem.location}/>
      })}
    </div>
    </>
  )
